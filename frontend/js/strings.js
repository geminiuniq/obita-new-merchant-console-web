...
export const STRINGS = {
    en: {
        ...
        'payouts.sub':           'Merchant withdrawals. The backend enforces 4-eyes approval, address allowlist, and 24h cool-down at the schema level.',
        ...
        'payouts.empty.head':    'No withdrawals yet. ',
        'payouts.empty.body':    'Click "+ New withdrawal" to start a 4-eyes flow.',
        'payouts.action.approve':'Approve',
        'payouts.action.reject': 'Reject',
        'payouts.approve.confirm':'Approve this withdrawal? It will be submitted to custody once the second-eye review passes.',
        'payouts.reject.prompt': 'Reason for rejection?',
        'payouts.toast.created': 'Withdrawal request submitted. Pending 4-eyes approval.',
        'payouts.toast.approved':'Approved + submitted to custody.',
        'payouts.toast.rejected':'Withdrawal rejected — reserve released.',
        'payouts.modal.title':   'New Withdrawal',
        'payouts.modal.chain':   'Chain',
        'payouts.modal.asset':   'Asset',
        'payouts.modal.amount':  'Amount',
        'payouts.modal.to':      'Destination address',
        'payouts.modal.foureyes':'A second user (e.g. demo_approver) must approve before broadcast.',
        'payouts.modal.cancel':  'Cancel',
        'payouts.modal.submit':  'Submit request',
    ...
    zh: {
        ...
        'payouts.col.id':        '编号 / 交易',
        'payouts.col.chain':     '链',
        'payouts.col.to':        '收款地址',
        'payouts.col.amount':    '金额',
        'payouts.col.status':    '状态',
        'payouts.col.when':      '提交时间',
        'payouts.col.actions':   '操作',
        'payouts.empty.head':    '暂无提现请求。',
        'payouts.empty.body':    '点击"+ 新建提现"开启 4-eyes 流程。',
        'payouts.action.approve':'审批通过',
        'payouts.action.reject': '驳回',
        'payouts.approve.confirm':'确认审批通过？审批通过后将自动提交至托管商。',
        'payouts.reject.prompt': '驳回原因？',
        'payouts.toast.created': '已提交提现请求，等待第二审批人复核。',
        'payouts.toast.approved':'已审批并提交至托管商。',
        'payouts.toast.rejected':'已驳回，预留资金已释放。',
        'payouts.modal.title':   '新建提现',
        'payouts.modal.chain':   '链',
        'payouts.modal.asset':   '资产',
        'payouts.modal.amount':  '金额',
        'payouts.modal.to':      '收款地址',
        'payouts.modal.foureyes':'需另一位用户（如 demo_approver）审批通过后才会广播。',
        'payouts.modal.cancel':  '取消',
        'payouts.modal.submit':  '提交申请',
